...
abstract class AppLocalizations {
  ...
  /// No description provided for @navNewBooks.
  ///
  /// In en, this message translates to:
  /// **'New Books'**
  String get navNewBooks;
  ...
  /// No description provided for @navAdvancedSearch.
  ///
  /// In en, this message translates to:
  /// **'Advanced Search'**
  String get navAdvancedSearch;

  /// No description provided for @booksNewList.
  ///
  /// In en, this message translates to:
  /// **'New books list'**
  String get booksNewList;

  /// No description provided for @updatesLatest.
  ///
  /// In en, this message translates to:
  /// **'Latest updates'**
  String get updatesLatest;
